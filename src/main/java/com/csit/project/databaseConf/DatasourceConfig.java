package com.csit.project.databaseConf;
...
public class DatasourceConfig {
	...
	/*
	 * set all the parameter into some variable to ferther use in this class
	 * only
	 * 
	...
	public DataSource dataSource() {
		...
		// configer datasource for accessing databasee through hibernate
	...
	public LocalSessionFactoryBean sessionFactoryBean() {
		...
		/**
		 * config hibernate5 session to use all over the project
		 */
